...
const Work = () => {
    ...
    return (
        <div ref={ref} name='work' className='w-full h-full pt-60 text-white bg-[#2d2d2d]'>
            <motion.div
                variants={{
            ...
            >
                ...
                {gridItemImages.map((image, index) => (
                    ...
                    <motion.div
                        ...
                        className='shadow-lg shadow-gray-400 group container rounded-md flex justify-center w-3/4 h-60 items-center mx-auto pt-16 content-div outline outline-offset-0 hover:outline-offset-8 '
                    >
                        ...
                        >
                            ...
                            <div className='pt-8 text-center'>
                                <a href={demoLinks[index]} target="_blank" rel="noopener noreferrer">
                                    <button className='text-center w-40 h-15 rounded-lg px-4 py-3 m-2 bg-black text-gray-100 font-bold text-lg'><FiArrowUpRight className='mr-2 size-5 hover:size-7' /></button>
                                </a>
