...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      className='relative bg-[#2d2d2d] pb-20 w-screen min-h-screen flex flex-col justify-center items-center text-center overflow-hidden'
    >
      {/* Floral Circles */}
      ...
      <div className='relative z-10 w-screen  max-w-lg'>
        <h1 className='text-[white] text-4xl font-bold sm:text-5xl pb-2'>Product <span className='text-[#6a5acd]'>Designer</span> </h1>
        <h1 className='text-white text-4xl font-bold sm:text-5xl pt-2'> <span className='text-[#6a5acd]'>Building</span> Things</h1>
