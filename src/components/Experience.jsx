...
const Experience = () => {
  ...
  return (
    <div ref={ref} name='experience' className='w-full h-full bg-[#2d2d2d] flex justify-center items-center'>
      <motion.div
        variants={{
      ...
      >
        <div className='w-full mx-auto p-4 pt-80 text-white'>
          <motion.div
            variants={{
          ...
          <div className='flex flex-col justify-stretch items-center pt-14'>
            <div className='max-w-[90%] grid grid-cols-1 sm:grid-cols-2 gap-8 px-4 text-[#6a5acd]'>
              <div name='left' className='text-left text-sm font-thin text-white'>
                <motion.p
                  variants={{
                    hidden: { opacity: 0, x: -50 },
                    visible: { opacity: 1, x: 0 },
                  ...
                  transition={{ duration: 1, delay: 0.5 }}
                >
                    Product designer and tech writer with 2+ years creating and designing compelling brand stories                
                </motion.p>
                <motion.p
                  variants={{
                    hidden: { opacity: 0, x: -50 },
                  ...
                  animate={leftControls}
                  transition={{ duration: 1, delay: 0.5 }}
                  className='pt-6 text-left text-white'
                >
